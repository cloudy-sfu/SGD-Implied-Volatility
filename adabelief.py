...
class AdaBelief(optimizer_v2.OptimizerV2):
    """
    It implements the AdaBelief optimizer proposed by
    ...
    def __init__(
        ...
        Args:
            ...
            rectify: boolean. Whether to enable rectification as in AdaBelief
